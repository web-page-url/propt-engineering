...
export default function Learning3Page() {
  return (
    <>
      <Hero title="Module 3: Techniques and Strategies" subtitle="Welcome to the Prompt Engineering Power-Up!" />
