...
const Navbar = () => (
  <nav className="w-full bg-white dark:bg-gray-900 shadow-md py-3 px-4 flex flex-wrap items-center justify-between mb-8">
    <div className="font-bold text-lg text-blue-700 dark:text-blue-300 tracking-tight">Prompt Engineering</div>
    <div className="flex flex-wrap gap-4 text-sm sm:text-base">
      <Link href="/what-is-prompt-engineering" className="hover:text-blue-600 dark:hover:text-blue-400 font-semibold">What is Prompt Engineering?</Link>
